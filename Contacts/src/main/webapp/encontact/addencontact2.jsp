...
<body>
	<table>
		...
		<tr>
			<td>工号：</td>
			<td><input type="text" name="gh" id="gh"
		...
		<tr>
			...
			<td><input type="text" name="bz" id="bz"
				class="squareinput bottommargin_10" value="" /> <span id="error16"
				class="redletter"></span></td>
		</tr>
		<tr>
			<td></td>
			<td class="exit"><br/> 
			<input type="button" class="button" value="确定" onclick="addenfriend()"/> 
	...
	<script type="text/javascript">
		function addenfriend() {
			...
			$.ajax({
				type : "post",
				url : "encontactship/addencontact2",
				data : {
					lname : lname,
					fname : fname,
					sex : sex,
