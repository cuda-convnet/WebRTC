...
<!--  			<table id="engroupfatherlist" class="datatable">
				...
				<s:iterator id="engroup" value="engroups">
					<tr id="tr<s:property value="#engroup.fz"/>">
						...
						<td><a class="blueletter"
							href="engroupship/engroups4?fz=<s:property value="#engroup.fz"/>&lfz=<s:property value="#engroup.lfz"/>&fzmc=<s:property value="#engroup.fzmc"/>">查看</a>
							<a
			...
			<div class="divpage">
				共${total1}页 <a id="firstpage1" class="text" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&size=5">首页</a> 
					<a class="text" id="uppage1" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&page1=${page1-1}&size=5">上一页</a>
					<span class="currpage">${page1}</span> 
				<a class="text" id="nextpage1" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&page1=${page1+1}&size=5">下一页</a> 
				<a class="text" id="lastpage1" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&page1=${total1}&size=5">尾页</a>
			...
			<!--  
				...
				<form action="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&size=5" method="post">
		...
		&bz=<s:property value="#encontact.bz"/>"
			...
			<div class="divpage">
				共${total2}页 <a id="firstpage2" class="text" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&size=5">首页</a> 
					<a class="text" id="uppage2" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&page2=${page2-1}&size=5">上一页</a>
					<span class="currpage">${page2}</span> 
				<a class="text" id="nextpage2" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&page2=${page2+1}&size=5">下一页</a> 
				<a class="text" id="lastpage2" href="engroupship/engroups3?fz=${param.fz}&lfz=${param.lfz}&fzmc=${param.fzmc}&page2=${total2}&size=5">尾页</a>
