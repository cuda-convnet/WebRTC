...
public class ModEncontactAction extends BaseAction {
	...
	private static final Logger logger = Logger.getLogger(ModEncontactAction.class);
	...
	private Encontact encontact = null;
	private String result = "fail";
	
	public String execute() throws Exception{
		
		encontact = EncontactManager.updateEncontact2(id, lname, fname, sex, nc, birth, gh, zw, 
