...
var hideChatDiv = function(chatFriendId) {
	...
	chatBox = document.getElementById( MessagePrefix + chatFriendId);if(chatBox != null) chatBox.remove();//删除对话框
	activeItem = getActiveList(chatFriendId,MessagePrefix);if(activeItem != null) activeItem.remove();//删除会话列表对应项
...
var addMessageMsg = function(MsgDivId, userName, remoteUserName,data) {
	...
	//console.log("curUserId=" + curUserId);//我的名字
	//console.log("userName=" + userName);//发送人的名字
	//console.log("data="+data);//发送内容
	//console.log("remoteUserName="+remoteUserName);//对方名字
