...
import com.webrtc.auto.dao.EncontactDAO;
...
public class EncontactManager {
	...
	public static List<Encontact> findEncontactsByUsernameAndFzIds(String username,List<Integer> fzids)
	{
		try{	
			return encontactDAO.findByPropertyAndIds("emails",username,"fz", fzids);
		}catch (Exception e) {
			LOGGER.debug(e);
			return Collections.emptyList();
		}
