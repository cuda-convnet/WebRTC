...
<div id="groupContactInfo" style="display:none">
	<div class="panel panel-default">
		<div class="panel-heading">
			<a class="btn btn-default" onclick="">联系人信息</a>
		</div>
		<div style="position: absolute; top: 1.5em; right: 4em;">
			<span class="glyphicon glyphicon-remove"
				onclick="closeContactGroupInfo();"> </span>
		</div>
		<div class="panel-body">
			<div style="overflow: auto;">
				<input type="hidden" name="contactId" id="contact_contactId"
					value="" /> <input type="hidden" name="groupId"
					id="contact_groupId" value="" />
				<table>
					<tr>
						<td class="left_item_td">姓：</td>
						<td class="right_item_td" id="contactlname"></td>
					</tr>
					<tr>
						<td class="left_item_td">名:</td>
						<td class="right_item_td" id="contactfname"></td>
					</tr>
					<tr>
						<td class="left_item_td">性别:</td>
						<td class="right_item_td" id="contactsex"></td>
					</tr>
					<tr>
						<td class="left_item_td">昵称:</td>
						<td class="right_item_td" id="contactnc"></td>
					</tr>
					<tr>
						<td class="left_item_td">生日:</td>
						<td class="right_item_td" id="contactbirth"></td>
					</tr>
					<tr>
						<td class="left_item_td">职务:</td>
						<td class="right_item_td" id="contactzw"></td>
					</tr>
					<tr>
						<td class="left_item_td">部门:</td>
						<td class="right_item_td" id="contactbm"></td>
					</tr>
					<tr>
						<td class="left_item_td">办公电话:</td>
						<td class="right_item_td" id="contacttelp"></td>
					</tr>
					<tr>
						<td class="left_item_td">手机:</td>
						<td class="right_item_td" id="contactmobp"></td>
					</tr>
					<tr>
						<td class="left_item_td">邮箱:</td>
						<td class="right_item_td" id="contactemails"></td>
					</tr>
					<tr>
						<td class="left_item_td">通信地址:</td>
						<td class="right_item_td" id="contactaddress"></td>
					</tr>
					<tr>
						<td class="left_item_td">邮政编码:</td>
						<td class="right_item_td" id="contactpostcode"></td>
					</tr>
					<tr>
						<td class="left_item_td">备注:</td>
						<td class="right_item_td" id="contactbz"></td>
					</tr>
					...
					onclick="showModGroupContactPage()" />
					<input type="button"
					class="btn btn-default " value="删除联系人"
					onclick="startDelGroupContact()" />
				<!-- <button class="graybutton" onclick="return false;">取消</button> -->
				<input type="button" class="btn btn-default " value="关闭"
					onclick="closeContactGroupInfo()" />
			</div>
		</div>
	</div>
</div>
