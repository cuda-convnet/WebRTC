...
<div class="content" id="content" style="display: none">
			...
			<span> <img src="img/head/header2.jpg" alt="logo"
				...
				<div class="btn-group" style="margin-left: 5px;">
					...
					<ul class="dropdown-menu">
						<li><a href="javascript:void(0)" onclick="showAddFriend()">添加好友</a>
						</li>
						<li><a href="javascript:void(0)" onclick="showDelFriend()">删除好友</a>
						</li>
						<li><a href="javascript:void(0)" onclick="showAddGroup()">加入群组</a>
						</li>
						<li><a href="javascript:void(0)" onclick="showDelGroup()">退出群组</a>
						</li>
						<li><a href="javascript:void(0)" onclick="showCreateGroup()">创建群组</a>
						</li>
						<li><a href="javascript:void(0)" onclick="showDestroyGroup()">解散群组</a>
						</li>
						<li class="divider"></li>
	...
	<!-- add by guoxun -->
	<div id="addGroupModal" class="modal hide fade" role="dialog"
		aria-hidden="true" data-backdrop="static">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				aria-hidden="true">&times;</button>
		...
		<div class="modal-body">
			<input id="addGroupId" onfocus='clearInputValue("addGroupId")' />
	...
	<div id="delGroupModal" class="modal hide fade" role="dialog"
		aria-hidden="true" data-backdrop="static">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				aria-hidden="true">&times;</button>
		...
		<div class="modal-body">
			<input id="delGroupId" onfocus='clearInputValue("delGroupId")' />
	...
	<div id="destroyGroupModal" class="modal hide fade" role="dialog"
		aria-hidden="true" data-backdrop="static">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				aria-hidden="true">&times;</button>
	...
	<div id="createGroupModal" class="modal hide fade" role="dialog"
		aria-hidden="true" data-backdrop="static">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"
				aria-hidden="true">&times;</button>
		...
		<div class="modal-body">
			<div>
				群组账号<input id="createGroupId"
					onfocus='clearInputValue("createGroupId")' />
			</div>
			<div>
				群组描述<input id="createGroupDesc"
					onfocus='clearInputValue("createGroupDesc")' />
			</div>
			<div>
				群组最大成员数<input id="createGroupMax"
	...
	<!-- 确认消息通知 -->
	<div id="confirm-block-div-modal" class="modal fade hide" role="dialog"
		aria-hidden="true" data-backdrop="static">
		<div class="modal-header">
			<h3>订阅通知</h3>
		</div>
