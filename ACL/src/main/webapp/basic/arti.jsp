...
<body>
	<input id="pagename" type="hidden" value="arti"/>
	...
	<!-- 当人工总机模块返回SUCCESS时需要设置该隐藏域的value为servername,方便环信连接发消息用 -->
	<input id="servername" type="hidden" value=""/>
	<input id="requesternum" type="hidden" value="0"/>
	...
	<div class="rtc_head_box">
		<div class="rtc_head">
			...
			<div class="user_info">
				<div class="portrait">
					<img src="css/pc/images/img/portrait65_1.jpg" width="65" height="65" />
				</div>
	...
	<div class="rtc_box">
		...
		<div class="switchboard_head">
		    ...
		    <div class="switchboard_head_right">
		      <ul>
		        <li class="operation_close" onclick="exitChatWindow(servername.value)">关闭</li>
		        <li class="operation_time">查看记录</li>
		        <li class="operation_video" onclick="createCallVideoPageBefore(servername.value)">发起视频</li>
				<li class="operation_audio" onclick="createCallAudioPageBefore(servername.value)">发起音频</li>
		     	<li class="operation_file"><input type="file" name="files[]" onchange="CallFilesBefore(this,this.files,servername.value);" multiple>发送文件</li>
		      </ul>
		    </div>
		    <!------右侧操作 end-------> </div>
		<!--头部 菜单 end--> 
		...
		<!--主体-->
		  ...
		  <div class="input_chat_box">
		    <textarea id="input_box" name="" cols="" rows="" class="input_text" onkeydown = "checkArtiChatBoxEnterDown()" autofocus disabled style="cursor:not-allowed;"></textarea>
		    <div class="input_chat_edit">
			<div class="input_chat_edit_r"><input id="sendto_arti" type="button" value="发送" class="send_out btn_blue" onclick="sendText(servername.value)" disabled style="cursor:not-allowed;"/></div>
		    </div></div>
		    <!-- 编辑对话 end--> 
		  </div>
		  <!--左 end--> 
		  ...
		  <!--右-->
		  <div class="switchboard_box_r"> 
		     <ul class="switchboard_video">
		     	<li><img src="images/img/video4.jpg" /></li>
		     	<li><img src="images/img/video1.jpg" /></li>
		     </ul>
		  </div>
		  <!--右 end--> 
		<!--主体 end--> 
	...
	<script type='text/javascript' src='js/pc/webrtc_pc/RtcVideoAudio.js'></script>
  	...
  	<!-- by yck 自动总机 -->
  	<script type='text/javascript' src='js/pc/webrtc_pc/ArtiUI.js'></script>
    <script type="text/javascript" src="js/pc/webrtc_pc/ArtiSwitchBoard.js"></script>
	<script type="text/javascript" src="js/pc/webrtc_pc/ArtiUserSession.js"></script>
</body>
</html>