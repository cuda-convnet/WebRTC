	...
	<div class="rtc_box">
		...
		<div class="rtc_box_left">
			...
			<div class="rtc_menu">
				<ul>
					...
					<li><i><img src="css/pc/images/rtc_menu_icon3.png"
							width="50" height="50" /></i><a href="javascript:void(0)">视频分享</a></li>
		...
		<div class="rtc_box_right">
				...
				<div class="friend_search">
					<span class="search_tips">提示</span>
				</div>
				<!--右 搜索框 end-->
				...
				<div class="friend_list_box">
					<div id='list_friend'><!--目前好友分组是写死的，以后要按照通讯录修改-->
					    <h2 class="friend_h2" id="friendh2" onclick="showListFriendUL();"><i class='ul_close'></i>
                                                                                  我的好友<span class='num'>3/10</span></h2>
