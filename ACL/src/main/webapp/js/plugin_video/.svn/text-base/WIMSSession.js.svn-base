            ...
            if(msg.roap.type === com.webrtc.protocol.RTCRoapType['offer']){
                ...
                if(moduleType == com.webrtc.UserSession.MODULE_TYPE.VIDEO)
                {
                    ...
                    if(false == this.isExistModule(sessionID))
                    {
                        ...
                        var configuration = new Conf(com.webrtc.UserSession.TYPE.IMS,com.webrtc.UserSession.MODULE_TYPE.VIDEO,false,false,{"urls": "turn:222.200.180.144", "url": "turn:222.200.180.144","credential":"123456","username":"gsta"},false);
                ...
                else if(moduleType == com.webrtc.UserSession.MODULE_TYPE.AUDIO)
                {
                    ...
                    if(false == this.isExistModule(sessionID))
                    {
                        ...
                        var configuration = new Conf(com.webrtc.UserSession.TYPE.IMS,com.webrtc.UserSession.MODULE_TYPE.AUDIO,false,false,{"urls": "turn:222.200.180.144", "url": "turn:222.200.180.144","credential":"123456","username":"gsta"},false);
