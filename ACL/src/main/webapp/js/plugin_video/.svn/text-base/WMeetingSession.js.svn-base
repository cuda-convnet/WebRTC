            ...
            if(msg.roap.type === com.webrtc.protocol.RTCRoapType['offer']){
                ...
                if(moduleType == com.webrtc.UserSession.MODULE_TYPE.VIDEOMEETING)
                {
                    ...
                    if(false == this.isExistModule(sessionID))
                    {
                        ...
                        //var configuration = new Conf(com.webrtc.UserSession.TYPE.MEETING,com.webrtc.UserSession.MODULE_TYPE.VIDEOMEETING,false,true, {"urls" : "stun:23.21.150.121","url" : "stun:23.21.150.121"},false);
                ...
                else if(moduleType == com.webrtc.UserSession.MODULE_TYPE.AUDIOMEETING)
                {
                    ...
                    if(false == this.isExistModule(sessionID))
                    {
                        ...
                        //var configuration = new Conf(com.webrtc.UserSession.TYPE.MEETING,com.webrtc.UserSession.MODULE_TYPE.AUDIOMEETING,false,true, {"urls" : "stun:23.21.150.121","url" : "stun:23.21.150.121"},false);
