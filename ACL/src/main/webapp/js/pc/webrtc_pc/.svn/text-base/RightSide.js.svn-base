...
//	}
//
//	var contentDiv = getGroupContactChatDiv(chatGroupId);//chatGroupId=group1+134079258417955440
//
//	if (contentDiv==null) { //不存在
//		var newContent = createGroupChatDiv(chatGroupId,chatGroupName);
//		document.getElementById("web").appendChild(newContent);
...
//	document.getElementById( MessagePrefix + chatFriendId).setAttribute("style","display:none;");
//	globalCur=null;
//};*/
//
////隐藏群组会话界面
...
//
//	document.getElementById( GroupPrefix + chatGroupId).remove();//删除对话框
//	document.getElementById(chatGroupId.split("+")[0] + GroupPrefix + chatGroupId + "activelist").remove();//删除会话列表对应项
//	globalCur=null;
//};
//
///*// 清空聊天界面
...
//	var textarea = $("<textarea id="+Div+"message name=\"\" cols=\"\" rows=\"\" class=\"input_text\" onkeydown='checkEnterDown(\""+Div+"\")'></textarea>");
//	var input_edit = $("<div class=\"input_chat_edit\"></div>");
