		...
		generate:function (){
			...
			var mytip = "<div class=\"tipbox-wrapper\">" +
				...
				"<div class=\"main-content\">" +
					...
					"</div>"+
					"<div class=\"rightalign\"><a class=\"blueletter\" href=\""+ this.info.url +"\">"+ this.info.formore +"</a>";
			if(this.info.formore1 !=null && this.info.formore1 != "" && this.info.url1 != null && this.info.url1 != ""){
				mytip += "<a class=\"blueletter leftmargin_5\" href=\""+ this.info.url1 +"\">"+ this.info.formore1 +"</a>";
			}
				mytip += "</div>"
						+"</div>"+
						"</div>";
