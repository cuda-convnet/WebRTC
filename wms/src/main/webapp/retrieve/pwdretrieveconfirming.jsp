				...
				<div class="col-md-offset-4 col-md-4">
					...
					<div class="form-group">
						<div style="max-width: 360px; margin: 0 auto">
							<p class="bigsize" style="line-height: 30px; text-indent: 2em;">一封密码重置邮件已经发送至您的邮箱，点击邮件中的链接，将打开密码重置页面，您可以使用此页面完成密码重置！</p>
							<p class="bigsize" style="line-height: 30px; text-indent: 2em;">
								如果您半个小时内仍未收到邮件，请点击"
        			<a class="blackletter" href="account/pwdretrievecheck?email=<%=java.net.URLEncoder.encode(email)%>">
        			再次发送</a>"
							</p>
						</div>
					</div>
